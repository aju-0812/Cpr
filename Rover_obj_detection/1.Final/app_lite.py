...
st.set_page_config(page_title="Rover AI Vision (Final Light)", layout="wide")

st.title("🚜 Caterpillar-AI Autonomous Rover Vision (Final Light)")
st.markdown("""
...
def load_model():
    ...
    # Look for the quantized tflite model in the models directory
    model_path = os.path.join(base_dir, 'models', 'yolo_quantized.tflite')
    ...
    if os.path.exists(model_path):
        ...
        st.error("Quantized model not found in 'models/' directory.")
        return None
